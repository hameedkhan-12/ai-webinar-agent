...
CREATE TABLE "AgentVoiceConfig" (
    ...
    CONSTRAINT "AgentVoiceConfig_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AgentVoiceConfig_assistantId_key" ON "AgentVoiceConfig"("assistantId");

-- CreateIndex
CREATE INDEX "AgentVoiceConfig_userId_idx" ON "AgentVoiceConfig"("userId");

-- CreateIndex
CREATE INDEX "AgentVoiceConfig_voiceId_idx" ON "AgentVoiceConfig"("voiceId");
...
-- AddForeignKey
ALTER TABLE "AgentVoiceConfig" ADD CONSTRAINT "AgentVoiceConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AgentVoiceConfig" ADD CONSTRAINT "AgentVoiceConfig_voiceId_fkey" FOREIGN KEY ("voiceId") REFERENCES "Voice"("id") ON DELETE CASCADE ON UPDATE CASCADE;
