...
import { VOICE_CATEGORIES } from '@/lib/voiceCategories'
...
export async function POST(request: Request) {
  ...
  // Custom voice cloning is a paid add-on, separate from the base
  // subscription - gate voice creation on that specific entitlement.
  ...
  try {
    ...
    const r2ObjectKey = `voices/users/${userId}/${voice.id}`
